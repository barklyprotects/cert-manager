...
functionality in cert-manager can be found in the [official deploying docs](https://github.com/barklyprotects/cert-manager/blob/master/docs/user-guides/deploying.md#addendum).
...
https://github.com/barklyprotects/cert-manager/tree/master/docs/api-types/issuer

For information on how to configure cert-manager to automatically provision
Certificates for Ingress resources, take a look at the `ingress-shim`
documentation:

https://github.com/barklyprotects/cert-manager/blob/master/docs/user-guides/ingress-shim.md
